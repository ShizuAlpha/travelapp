...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView fname = (TextView) findViewById(R.id.textViewUser);
        TextView lname = (TextView) findViewById(R.id.textViewFirstName);
        TextView username = (TextView) findViewById(R.id.textViewLastName);
