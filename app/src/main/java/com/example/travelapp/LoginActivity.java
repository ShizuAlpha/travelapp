        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (dbHandler.checkUser(username.getText().toString(),pass.getText().toString()))
                {
                    ...
                    editor.commit();
                    Toast.makeText(getApplicationContext(), getResources().getString(R.string.login_succes), Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(LoginActivity.this ,MainActivity.class);
                    startActivity(intent);
                    finish();
                }
                else {
                    Toast.makeText(getApplicationContext(), getResources().getString(R.string.failed_login), Toast.LENGTH_SHORT).show();
                }
            }
        });
